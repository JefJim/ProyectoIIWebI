...
<body class="h-full">
    <div class="min-h-full">
        ...
        <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                        ...
                        <?php foreach ($arboles as $arbol): ?>
                            <tr class="bg-white border-b hover:bg-green-50">
                                ...
                                <td class="px-6 py-4 space-x-2">
                                    ...
                                    <a href="/admin/arboles/<?= esc($arbol['id']) ?>/historial" class="text-blue-600 hover:text-blue-800">Ver Historial</a>
                                    <!-- Acción para agregar nueva actualización -->
                                    <a href="/admin/arboles/<?= esc($arbol['id']) ?>/historial/agregar" class="text-green-600 hover:text-green-800">Agregar Actualización</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <!-- Botón Volver -->
            <div class="mt-6">
                <a href="/admin/amigos" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded text-sm text-white">
