...
<body class="h-full">
    <div class="flex justify-center items-center min-h-screen">
        <div class="max-w-lg w-full bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="/admin/arboles/<?= esc($arbol['id']) ?>/historial/guardar" method="post" enctype="multipart/form-data" class="space-y-6 mt-4">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded text-sm text-white">Guardar Actualización</button>
                </div>
            </form>
        </div>
    </div>
