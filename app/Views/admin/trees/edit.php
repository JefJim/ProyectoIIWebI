...
<body class="h-full">
    <div class="flex justify-center items-center min-h-screen">
        <div class="max-w-lg w-full bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="<?= base_url('admin/arboles/editar/' . $tree['id']) ?>" method="post" enctype="multipart/form-data" class="space-y-6 mt-4">
                <!-- Especie -->
                <div>
                ...
                <div>
                    ...
                    <input type="number" id="precio" name="precio" step="0.01" value="<?= esc($tree['precio']) ?>" required 
                        class="block w-full rounded-md border-0 py-2 text-green-900 shadow-sm ring-1 ring-green-300 focus:ring-2 focus:ring-green-600">
                </div>
                ...
                <div>
                    ...
                    <?php if ($tree['foto']): ?>
                        <img src="<?= base_url('uploads/trees/' . esc($tree['foto'])) ?>" alt="Foto actual del árbol" class="h-16 w-16 object-cover mt-2 rounded">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded text-sm text-white">Actualizar</button>
                </div>
            </form>
        </div>
    </div>
