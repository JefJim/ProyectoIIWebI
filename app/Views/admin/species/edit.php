...
<body class="h-full">
    <div class="flex justify-center items-center min-h-screen">
        <div class="max-w-lg w-full bg-white p-6 rounded-lg shadow-lg">
            <h1 class="text-2xl font-bold text-center text-green-900">Editar Especie</h1>
            <form action="<?= base_url('admin/especies/editar/' . $species['id']) ?>" method="post" class="space-y-6 mt-4">
                <div>
                    <label for="nombre_comercial" class="block text-sm font-medium text-green-900">Nombre Comercial:</label>
                    <input id="nombre_comercial" type="text" name="nombre_comercial" value="<?= $species['nombre_comercial'] ?>" required
